...
<?= $this->section('content') ?>
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Kelas <?= $kelas?></li>x
        </ol>
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <td>NIS</td>
                    <td>Nama Siswa</td>
                    <td class="col-2 text-center">Jumlah kehadiran Presensi</td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="<?=base_url()?>/home/detail_presensi/<?=$data_siswa['nis_siswa']?>"><button class="btn btn-sm btn-primary">detail</button></a>
                    </td>
                </tr>
                <?php $i++; endforeach;?>
                <tr>
