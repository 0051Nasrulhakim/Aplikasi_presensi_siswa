    ...
    <div class="container-fluid px-4"id="contain">
        <div class="isi" style="margin-bottom: 3%;">
            <div class="judul" style="margin-bottom: 3%;">
                <h1 class="mt-4 text-center">Lembar Presensi</h1>
            ...
            <div class="container" style="border: 1px solid; border-radius: 9px; height: auto; margin-bottom: 10%;">
                <div class="table-responsive mb-5">
                    <form action="<?= base_url()?>/crud/presensi" clas="was-validated" method="post">
                                    ...
                                    <td>
                                        <div class="form" style="margin-left: 6%;">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" id="radio1" name="presensi[<?= $data_siswa['nis_siswa']?>]" value="hadir" required checked>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" id="radio2" name="presensi[<?= $data_siswa['nis_siswa']?>]" value="izin" required>
                                                <label class="form-check-label" for="radio<?= $data_siswa['nis_siswa']?>2">
                                                    Izin
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" id="radio4" name="presensi[<?= $data_siswa['nis_siswa']?>]" value="sakit" required>
                                                <label class="form-check-label" for="radio<?= $data_siswa['nis_siswa']?>3">
                                                    Sakit
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" id="radio3" name="presensi[<?= $data_siswa['nis_siswa']?>]" value="alpha" required>
                                                <label class="form-check-label" for="radio<?= $data_siswa['nis_siswa']?>3">
                                                    Alpha
                                                </label>
                                            </div>
